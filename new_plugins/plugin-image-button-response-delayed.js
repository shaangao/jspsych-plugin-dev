// adapted from jsPsych 7.3.3 ImageButtonResponse by Shan Gao


var jsPsychImageButtonResponseDelayed = (function (jspsych) {
  'use strict';

  const info = {
      name: "image-button-response-delayed",
      parameters: {
  ...
  class ImageButtonResponsePlugin {
      ...
      trial(display_element, trial) {
          //////////////////////// 
          // a hack to get around scope issue when referring to curr instance in nested methods after_response()
          var that = this;
          //////////////////////// 
          var height, width;
          var html;
          ...
          for (var i = 0; i < trial.choices.length; i++) {
              display_element
                  ...
                  var btn_el = e.currentTarget;   // button obj
          ...
          function after_response(choice) {     // choice is the idx of the pressed button in string type
              // measure rt
              ...
              for (var i = 0; i < btns.length; i++) {
                  ...
                  ////////////////////////////////////////////////
                  if (i != choice) {
                    // hide unclicked button
                    // btns[i].style.display = 'none';    // hide and re-arrange
                    btns[i].style.visibility = 'hidden';   // hide but reserve space
                  }
                  ////////////////////////////////////////////////
              }
              if (trial.response_ends_trial) {
                //   end_trial();
                /////////////////////////////////////////// 
                that.jsPsych.pluginAPI.setTimeout(() => {   // this "that" is a hack
                    end_trial();
                }, 5000);    // change length of delay here. millisecond.
                /////////////////////////////////////////// 
              }
          }
